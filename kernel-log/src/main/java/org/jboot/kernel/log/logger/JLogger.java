...
package org.jboot.kernel.log.logger;

import lombok.extern.slf4j.Slf4j;
import org.jboot.kernel.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class JLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info("{}: JLogger init success!", serviceId);
	}
