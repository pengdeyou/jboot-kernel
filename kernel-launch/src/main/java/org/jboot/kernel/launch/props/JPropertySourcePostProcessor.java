...
package org.jboot.kernel.launch.props;
...
public class JPropertySourcePostProcessor implements BeanFactoryPostProcessor, InitializingBean, Ordered {
	...
	public JPropertySourcePostProcessor() {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		log.info("JPropertySourcePostProcessor process @JPropertySource bean.");
		Map<String, Object> beansWithAnnotation = beanFactory.getBeansWithAnnotation(JPropertySource.class);
		Set<Map.Entry<String, Object>> beanEntrySet = beansWithAnnotation.entrySet();
		// 没有 @YmlPropertySource 注解，跳出
		if (beanEntrySet.isEmpty()) {
			log.warn("Not found @JPropertySource on spring bean class.");
			return;
		}
		// 组装资源
		...
		for (Map.Entry<String, Object> entry : beanEntrySet) {
			...
			JPropertySource propertySource = AnnotationUtils.getAnnotation(beanClass, JPropertySource.class);
	...
	public void afterPropertiesSet() throws Exception {
		log.info("JPropertySourcePostProcessor init.");
	}
