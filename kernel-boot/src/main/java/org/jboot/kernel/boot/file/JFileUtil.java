...
public class JFileUtil {
	 ...
	 * @return JFile
	 */
	public static JFile getFile(MultipartFile file) {
	 ...
	 * @return JFile
	 */
	public static JFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return JFile
	 */
	public static JFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new JFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return JFile
	 */
	public static List<JFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return JFile
	 */
	public static List<JFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return JFile
	 */
	public static List<JFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<JFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new JFile(file, dir, path, virtualPath));
		}
		return list;
	}
