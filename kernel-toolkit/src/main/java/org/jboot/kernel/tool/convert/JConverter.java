package org.jboot.kernel.tool.convert;

import lombok.AllArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.jboot.kernel.tool.support.Try;
import org.jboot.kernel.tool.utils.ClassUtil;
import org.jboot.kernel.tool.utils.ConvertUtil;
...
@Slf4j
@AllArgsConstructor
public class JConverter implements Converter {
	 ...
	 * @param fieldName 目标的field名，原为 set 方法名，JBeanCopier 里做了更改
	 * @return {Object}
	 */
	@Override
	@Nullable
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = JConverter.getTypeDescriptor(targetClazz, (String) fieldName);
			return ConvertUtil.convert(value, targetDescriptor);
		} catch (Throwable e) {
			log.warn("JConverter error", e);
			return null;
		}
	}
