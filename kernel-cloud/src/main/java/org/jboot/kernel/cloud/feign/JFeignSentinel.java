...
import org.jboot.kernel.cloud.sentinel.JSentinelInvocationHandler;
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new JSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default(fallbackInstance));
					}
