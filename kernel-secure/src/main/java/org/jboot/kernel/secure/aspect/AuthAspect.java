...
package org.jboot.kernel.secure.aspect;

import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.reflect.MethodSignature;
import org.jboot.kernel.secure.annotation.PreAuth;
import org.jboot.kernel.secure.auth.AuthFun;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(org.jboot.kernel.secure.annotation.PreAuth) || " +
			"@within(org.jboot.kernel.secure.annotation.PreAuth)"
	)
